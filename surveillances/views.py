...
class ResetPlanningView(APIView):
    """
    DELETE /api/surveillances/reset/
    Supprime toutes les surveillances et remet les heures à zéro.
    À utiliser avant un nouvel import complet.
    """
    permission_classes = [IsAdmin]
    ...
    def delete(self, request):
        ...
        nb_surv = Surveillance.objects.count()
        nb_exam = Examen.objects.count()
        nb_dispo = Disponibilite.objects.count()
        ...
        return Response({
            'message':       'BDD nettoyée avec succès.',
            'suppressions':  {
                'surveillances':  nb_surv,
                'examens':        nb_exam,
                'disponibilites': nb_dispo,
            }
        })
